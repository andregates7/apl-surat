<div class="box box-solid">
   <div class="box-header with-border">
      <h3 class="box-title">REKAP AGENDA SURAT</h3>   
    </div>
    <div class="box-body">
      <div>
  ...
  <footer class="main-footer">
    <div class="container">
      <strong>Copyright &copy; 2021 LLDIKTI Wilayah XI Kalimantan</strong>
    </div>
    <!-- /.container -->
  </footer>
</div>
...
$("#cetak").on('click',function(){
  if ($('#awal').val()==''){
    ...
    var bulan=$('#bulan').val();
    window.open("report_agenda.php?awal="+awal+"&akhir=" + akhir);
  }
});
