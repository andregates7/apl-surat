...
$pdf->Cell(80);
$pdf->Cell(30,10,'Rekap Surat Masuk '.$nama_bulan,0,0,'C');
$pdf->Ln(12);

//table Head
$pdf->SetFont('Arial','B',10);
$pdf->SetWidths(array(15,46,15,60,27,28));
$pdf->SetAligns(array('C','C','C','C','C','C'));
$pdf->Row(array('No Agenda','No Surat','Kode','Asal Surat','Tanggal Masuk','Jenis Klasifikasi'));
...
foreach ($result as $row) 
{
    ...
    $klasifikasi             = $row["jenis_klasifikasi"];

    //Now show the columns
    $pdf->SetFont('Arial','',10);
    $pdf->SetAligns(array('C','L','C','L','C','C'));
    $pdf->Row(array($no_agenda,$no_surat,$kode,$asal_surat,$tgl_surat,$klasifikasi));
}
...
$pdf->Output('Laporan Rekap Surat Masuk','I');
?>